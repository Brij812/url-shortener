...
export default function CreateForm() {
  ...
  async function onSubmit(values: FormValues) {
    try {
      ...
      // handle both plain string & JSON return types
  ...
  return (
    <div className="max-w-xl mx-auto mt-16 p-4">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        className="border-2 border-gray-800 p-6 rounded-xl space-y-4 bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg"
      >
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          <div className="flex flex-col space-y-2">
            ...
            <input
              ...
              className="border-2 border-gray-800 p-3 text-lg font-mono rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900 bg-white"
            />
        ...
        {result && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mt-6 border-t-2 border-gray-800 pt-4 space-y-3"
          >
            <p className="font-semibold text-lg text-gray-800">Your Short URL</p>
